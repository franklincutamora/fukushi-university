...
<div class="cl_modal_wrp modal_wrp">
    <div class="cl_modal_cntr">
        <div class="cl_modal_bx kai">
            <small class="close_modal"><i class="material-icons kai">close</i></small>
            <figure>
                <img src="<?php bloginfo('template_url'); ?>/assets/img/kaigo/mn_icon1.png" alt="hoiku image">
            </figure>
            <h3>資格と仕事</h3>
            <p>介護福祉士は、身体や精神上の障がいで日常生活に支障がある方の介護と、周囲への介護指導を行う職業です。介護を必要とされる方が増え、採用ニーズも年々高まっています。</p>
            <h4>目指せる資格</h4>
            <div class="mdl_boxes">
                <div class="gap gap-0 gap-0-xs">
                    <div class="md-12 xs-12">
                        <div class="mdl_box kai bg_grn">
                            <h5>介護福祉士</h5>
                            <p>厚生労働省国家資格</p>
                        </div>
                    </div>
            ...
            <div class="mdl_links">
                <div class="gap gap-10 gap-10-xs">
                    <div class="md-6 xs-6">
                        <a href="/kaigo/shikaku/#a1">目指せる資格 <i class="material-icons">arrow_forward</i></a>
                    </div>
                    <div class="md-6 xs-6">
                        <a href="/kaigo/shikaku/#a2">目指せる仕事 <i class="material-icons">arrow_forward</i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="mn_banner kai_bnr">
    <div class="cntr">
        <div class="mn_banner_cntr">

            <div class="mn_title_box">
                <h3 class="mn_title kai">Care Work</h3>
                <h4 class="mn_subtitle"><?php the_title(); ?> <span>２年制・定員40名 <small>[職業実践専門課程]</small></span></h4>
            </div>

            <div class="side_title kaigo">
                 
                <span>寄り添うほどに、</span>
                <span>笑顔って広がっていく。</span>
            </div>

            <div class="btn_circle kai modal_btn">
                <h4>資格と仕事</span></h4>
                <i class="material-icons kai">add</i>
            </div>
    ...
    <div class="cntr2">
        <div class="mn_dep_cntr">
            ...
            <figure class="dep_img1">
                <img src="<?php bloginfo('template_url'); ?>/assets/img/kaigo/dep_img1.png" alt="kaigo image">
            </figure>

            <h3 class="dep_title">この学科の <span class="kai_bfr">ココ</span>が凄い!</h3>
                        ...
                        <?php while( have_rows('card_content') ): the_row(); 
                            ...
                            <div class="md-3 xs-6 mb-0 mb-30-xs sp-560">
                                <div class="dep_box">
                                    ...
                                    <div class="dep_txt">
                                        <span class="bg_grn"><?php echo $dept_card_tag; ?></span>
            ...
            <div class="tc">
                <a class="mn_btn kai" href="<?php bloginfo('url'); ?>/kaigo/shushoku/">就職実績 <i class="material-icons">arrow_forward</i></a>
            </div>
    ...
    <div class="cntr">
        <div class="mn_table_cntr">
            ...
            <figure class="sp_scroll">
                <img src="<?php bloginfo('template_url'); ?>/assets/img/kaigo/sp_scroll.png" alt="hoiku image">
            </figure>
            <h3 class="mn_table_title">タイムテーブル</h3>

            <div class="mn_table_box_wp">
                <div class="mn_table_box">
                    <table class="table_box rob_table_box_kaigo">
                        <thead>
                        <tr class="table_head kai">
                            <th>TIME</th>
                            <th>MON</th>
                            <th>TUE</th>
                            <th>WED</th>
        ...
        <div class="dd_box_wp">
            <?php if( have_rows('accordion_content') ): ?>
                <?php while( have_rows('accordion_content') ): the_row(); 
                    ...
                    ?>
                        <div class="dd_box">
                            <h3 class="dd_box_title kai dd_btn"><?php echo $acc_tit; ?> <i _ngcontent-krq-c19="" class="material-icons icon-image-preview">keyboard_arrow_down</i></h3>
                            <?php echo $acc_cont; ?>
                        </div>
