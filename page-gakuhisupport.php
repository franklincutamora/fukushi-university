...
<section class="wrp rob-padding-tb">
    <div class="lg_cntr">
        ...
        <div class="sm_cntr">
            ...
            <!-- Gakuhi Support -->
            <div class="gakuhisupport">
                <h1 class="rob-title rob-title-uline">
                    <span><?php the_title(); ?></span>
                </h1>
                <?php if( have_rows('juk_box') ): $i = 0; ?>
                    <?php while( have_rows('juk_box') ): the_row(); 
                        ...
                        <div class="rob-mb-box">
                            <h3 id="section-<?php echo $i; ?>" class="rob-title rob-title-lline" style="border-color: <?php echo $juk_tit_color; ?> ">
